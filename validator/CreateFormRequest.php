...
$rules = [
    ...
    'lastName' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'dob' => 'required|year|now|ageNotGreaterThan:120',
    'gRadio' => 'required',
    'nationality' => 'required',
    'nationalityInput' => 'nationalityOtherRequired|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'occupation' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'religion' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'snsUsername' => 'required|notNumber|lengthNotGreaterThan:128',
    'jpRadio' => 'required',
    'region' => 'regionCheckNotNever',
    'dietary' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'email' => 'required|email',
    'phone' => 'required|phoneNumber|phoneBetween:7,25',
    'tFirstName' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tLastName' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tDob' => 'required|year|now|ageNotGreaterThan:120',
    'sgRadio' => 'required',
    'tNationality' => 'required',
    'tNationalityInput' => 'nationalityOtherRequired|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'relationship' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'tDietary' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'uploadAvatar' => 'required|fileSize:5|image:jpeg,jpg,png,svg,gif,webp',
    'gFirstName' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'gLastName' => 'required|notNumber|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tPeriod' => 'required',
    'uVideo' => 'required',
    'campaign' => 'required',
