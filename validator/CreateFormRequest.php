...
// Rules
$rules = [
    'firstName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'lastName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'dob' => 'required|year|now|ageNotGreaterThan:120',
    'gRadio' => 'required',
    'nationality' => 'required',
    'nationalityInput' => 'nationalityOtherRequired|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'occupation' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'religion' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'snsUsername' => 'required|notNumber|lengthNotGreaterThan:128',
    'jpRadio' => 'required',
    'region' => 'regionCheckNotNever',
    'dietary' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'email' => 'required|email',
    'phone' => 'required|phoneNumber|phoneBetween:7,25',
    'tFirstName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tLastName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tDob' => 'required|year|now|ageNotGreaterThan:120',
    'sgRadio' => 'required',
    'tNationality' => 'required',
    'tNationalityInput' => 'nationalityOtherRequired|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'relationship' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'tDietary' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:400',
    'uploadAvatar' => 'required|fileSize:5|image:jpeg,jpg,png,svg,gif,webp',
    'gFirstName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'gLastName' => 'required|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'tPeriod' => 'required',
    'uVideo' => 'required',
    'campaign' => 'required',
    'campaignInput' => 'campaignOtherRequired|specialCharacter&notNumber|lengthNotGreaterThan:128',
    'policy' => 'required'
];
